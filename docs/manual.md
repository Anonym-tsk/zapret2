...
```
 ...
 --fastpath-workaround=0|1|auto                         ; обход аппаратного fastpath при TLS reassembly: 0 - выключен (по умолчанию), 1 - всегда включен, auto - включается автоматически для IP после двух ретрансмиссий
